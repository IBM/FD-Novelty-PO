...
ALIASES["novelty-b"] = [
    "--evaluator", "hff=ff()",
    "--evaluator", "nff=novelty(evals=[hff],type=basic)",
    "--search", "lazy(tiebreaking([nff,hff]))"]

ALIASES["novelty-sn"] = [
    "--evaluator", "hff=ff()",
    "--evaluator", "nff=novelty(evals=[hff],type=separate_novel)",
    "--search", "lazy(tiebreaking([nff,hff]))"]

ALIASES["novelty-sb"] = [
    "--evaluator", "hff=ff()",
    "--evaluator", "nff=novelty(evals=[hff],type=separate_both)",
    "--search", "lazy(tiebreaking([nff,hff]))"]

ALIASES["novelty-sbb"] = [
    "--evaluator", "hff=ff()",
    "--evaluator", "nff=novelty(evals=[hff],type=separate_both_aggregate, multiplier=100, dump=true)",
    "--search", "lazy(tiebreaking([nff,hff]))"]
