...
protected:
    ...
    */
    ...
    double preferred_selection_probability;
    bool is_preferred_randomly_selected() { return ((*rng)() <= preferred_selection_probability); }
...
public:
    ...
    bool is_preferred(const OperatorProxy &op);
